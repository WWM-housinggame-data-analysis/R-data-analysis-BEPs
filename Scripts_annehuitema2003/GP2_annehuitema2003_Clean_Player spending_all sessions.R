...
source(file.path(functionfolder_path, "Build_comparison_table_function.R"))
# Read the database folder to create accordingly the dataframe tables
#UNCOMMMENT
session_2510 <- "housinggame_session_20_251007_VerzekeraarsMasterClass"
session_2509 <- "housinggame_session_19_250923_EPA_IntroDays_Overasselt"
...
for (nm in names(datasets_list)) {
  ...
  # ---- SESSION COMPARISON TABLE (NEW EXCEL) ----
  session_name_current <- unique(df_current$gamesession_name)[1]
  
  build_session_comparison_table(
    df_income_dist = df_current,
  ...
  message("[PLOT] welfare_spending_satisfaction_plot2 | dataset = ", nm, " | round = all ")
  welfare_spending_satisfaction_plot2(
    dataset         = df_current,
    group_name      = "all",
    round_number    = "all",
  ...
  message("[PLOT] welfare_personal_house_ratio_plot | dataset =", nm, " | round = all")
  welfare_personal_house_ratio_plot(
    dataset         = df_current,
    group_name      = "all",
    round_number    = "all",
  ...
  message("[PLOT] housingarea_avg_inhabitants_plot | dataset = ", nm, " | round = all")
  ...
  for (r in rounds_in_dataset) {
    ...
    message("[PLOT] welfare_spending_satisfaction_plot2 | dataset = ", nm, " | round = ", r)
    welfare_spending_satisfaction_plot2(
      dataset = df_round, 
      group_name = "all",
      round_number = r, 
    ...
    message("[PLOT] welfare_personal_house_ratio_plot | dataset = ", nm, " | round = ", r)
    welfare_personal_house_ratio_plot(
      dataset         = df_round,
      group_name      = "all",
      round_number    = r,
    ...
    message("[PLOT] housingarea_avg_inhabitants_plot | dataset = ", nm, " | round = ", r)
    housingarea_avg_inhabitants_plot(
      dataset         = df_round,
      group_name      = "all",
      round_number    = r ,
