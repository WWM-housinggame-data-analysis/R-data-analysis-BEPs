...
# -----------------------------
# Settings: kies input/output
# -----------------------------

# 1) Het Improv_dist bestand dat je al hebt gemaakt
improv_file <- file.path(data_output_path, paste0("Improv_dist_", dataset_date, ".xlsx"))

# 2) Het bijbehorende "with_classes" bestand per sessie/datum
classes_file <- switch(dataset_date,
                       "240924" = file.path("data_output", "session_2024-09_with_classes.xlsx"),
                       "250923" = file.path("data_output", "session_2025-09with_classes.xlsx"),
                       "251007" = file.path("data_output", "session_2025-10_with_classes.xlsx"),
                       stop("No matching classes file found for dataset_date: ", dataset_date)
)
